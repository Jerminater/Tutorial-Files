...
import scripts.jTears.antiban.JTearsAntibanProfile;
import scripts.jTears.utils.JTearsUtil;
import scripts.jTutorial.data.Vars;

/**
 * Thanks to Einstein and Naton. Their scripts were used to build this tutorial.
 */
public class JTutorialAntiban {
	...
	// Instance Manip
	private static JTutorialAntiban antiban;
	
	private JTutorialAntiban () {}

	public static JTutorialAntiban get() {
		return antiban == null ? antiban = new JTutorialAntiban() : antiban; 
	}
	
	public static void clear() {
		antiban = new JTutorialAntiban();
	}
	// End Instance Manip
	...
	public void abcSleepAfterAction() {
		sleepReactionTime((int) lastWaitTime);
	}
	
	// This is an example I use in my TOG script which selects a new target to collect tears.
